...
REQUIRED = (
    "m", "n", "k", "source", "name", "layout_a", "layout_b", "layout_c",
...
def main() -> int:
    ...
    report_fields = [
        ...
        "source", "name", "layout_a", "layout_b", "layout_c",
        "align_a", "align_b", "align_c", "tb_m", "tb_n", "tb_k",
        "warp_m", "warp_n", "warp_k", "swizzle", "stages", "split_k",
    ...
    metadata = {
        ...
        "models": args.models, "unique_shapes": len(winners),
